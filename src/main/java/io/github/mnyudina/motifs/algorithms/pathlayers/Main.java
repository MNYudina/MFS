package io.github.mnyudina.motifs.algorithms.pathlayers;

import edu.uci.ics.jung.algorithms.generators.GraphGenerator;
import edu.uci.ics.jung.graph.Graph;
import edu.uci.ics.jung.io.PajekNetReader;
import io.github.mnyudina.motifs.algorithms.pathspeedup.PathNonTree;
import io.github.mnyudina.motifs.algorithms.branchspeedup.PAGenerator;
import io.github.mnyudina.motifs.algorithms.pathspeedup.PathTree;
...
public class Main {
    ...
    public static void main(String[] args) throws IOException, GraphStatsException { // for DEBUG
        ...
        PathTreeDirectlyMap p4= new PathTreeDirectlyMap<>(graph,i);
        p4.execute();
        System.out.print(";"+(System.currentTimeMillis() - startTime)+"; ;");
        startTime = System.currentTimeMillis();
        PathNonTreeLayer p5= new PathNonTreeLayer(graph,i);
    ...
    public static void main2(String[] args) throws IOException, GraphStatsException { // for DEBUG
        ...
        //   String path="graphs\\MyAs.net";
            ...
            long startTime = System.currentTimeMillis();
            PathNonTree p4= new PathNonTree<>(graph,100000);
            p4.execute();
            System.out.print(";"+(System.currentTimeMillis() - startTime)+"; ;");

            startTime = System.currentTimeMillis();
            PathTreeDirectlyMap p5= new PathTreeDirectlyMap<>(graph,100000);
            p5.execute();
            System.out.println("; "+(System.currentTimeMillis() - startTime));
